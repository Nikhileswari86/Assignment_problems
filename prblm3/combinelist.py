def is_more_than_half_overlap(pos1, pos2):
    """
    Check if more than half of pos1 is inside pos2 or vice versa.
    pos1 and pos2 are tuples: (left, right)
    """
    l1, r1 = pos1
    l2, r2 = pos2
    len1 = r1 - l1
...
def combine_lists(list1, list2):
    ...
    # Add remaining unused elements from list2
    for j, elem2 in enumerate(list2):
        if j not in used:
            combined.append(elem2)

    # Sort by left_position
